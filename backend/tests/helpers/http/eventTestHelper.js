...
const createEventAsAuthenticatedUser = (
    headers = {},
    overrides = {}
) => {
    return request(app)
...
const createMultipartEventRequest = (
    headers = {},
    fields = {}
) => {
    return request(app)
        ...
        .field(
            "startDateTime",
            fields.startDateTime ?? "2026-12-31T10:00:00.000Z"
        )
        .field(
            "endDateTime",
            fields.endDateTime ?? "2026-12-31T12:00:00.000Z"
        );
};

const createEventWithImage = (
    headers = {},
    fields = {},
    image = {}
) => {
...
const updateMultipartEventRequest = (
    eventId,
    headers = {},
    fields = {}
) => {
...
const getAuthenticatedEventAccess = (
    eventId,
    headers = {}
) => {
    return request(app)

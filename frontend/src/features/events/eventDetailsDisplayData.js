import { formatEventDateRange, formatTime } from "../../utils/formatters";

import { EVENT_MODES, getEventModeLabel } from "../shared/eventModes";

/* ==================================================
   EVENT DETAILS DISPLAY DATA
   Builds display-ready values for event details page
...
export function getEventDetailsDisplayData(event) {
